...
class UserForm(forms.Form):
    username = forms.CharField(max_length=128, label='用户名', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': "Username", 'autofocus': ''}))
    password = forms.CharField(max_length=256, label='密码', widget=forms.PasswordInput({'class': 'form-control', 'placeholder': "Password"}))
...
class RegisterForm(forms.Form):
    ...
    email = forms.EmailField(label="邮箱地址", widget=forms.EmailInput(attrs={'class': 'forms-control'}))
